 ...
 import com.sitera.pos.base.Response;
 import com.sitera.pos.exception.EmptyResponseBodyException;
 import com.sitera.pos.util.CommonUtil;
 import com.sitera.pos.util.ConstantApp;
 ...
 public class CustomExceptionHandler {
     ...
     public ResponseEntity<Response> handleException(Exception e) {
         return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                 .header(ConstantApp.TRANSACTION_ID, commonUtil.getTransactionId())
